...
class ProductController extends Controller
{
    ...
    public function store(Request $request, Product $product)
    {
        $request->validate([
            ...
            'image1' => 'required|image|mimes:jpeg,png,jpg,gif,svg,webp|max:4096',
            'image2' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:4096',
            'image3' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:4096',
        ], [
    ...
    public function update(Request $request, Product $product, $id)
    {
        ...
        $request->validate([
            ...
            'brand_id' => 'required',
            'description' => 'required|string',
            'image1' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:4096',
            'image2' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:4096',
            'image3' => 'nullable|image|mimes:jpeg,png,jpg,gif,svg,webp|max:4096',
        ], [
            'name.required' => 'O nome do produto é obrigatória.',
